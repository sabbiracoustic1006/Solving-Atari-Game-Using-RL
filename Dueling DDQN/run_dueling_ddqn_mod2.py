...
import argparse
import numpy as np
from dueling_ddqn_mod2 import DuelingDDQNAgentMod
...
def train(args):
    ...
    agent = DuelingDDQNAgentMod(gamma=args.gamma, epsilon=epsilon, lr=args.lr,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--name_exp', default='DuelDDQN_Mod2_alpha_0_25', type=str, help='name of the experiment')
    ...
    parser.add_argument('--alpha', default=0.25, type=float, help='loss weighting to use for ghost state loss')
